...
<head>
    ...
    <!-- BOOTSTRAP CORE CSS -->
    <link href="/2/light-wave/light-wave/main-site/css/bootstrap.css" rel="stylesheet" />
    <!-- CUSTOM CSS -->
    <link href="/2/light-wave/light-wave/main-site/css/style.css" rel="stylesheet" />
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="preview-wrapper">
                    <a href="template/blue.html" target="_blank">
                        <img src="/2/light-wave/light-wave/main-site/img/previews/1.png" class="img-responsive" alt="" />
                        <hr />
                        <p>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="preview-wrapper">
                    <a href="template/green.html" target="_blank">
                        <img src="/2/light-wave/light-wave/main-site/img/previews/2.png" class="img-responsive" alt="" />
                        <hr />
                        <p>
...
<!-- CORE JQUERY SCRIPTS -->
<script src="/2/light-wave/light-wave/main-site/js/jquery-1.11.1.js"></script>
<!-- BOOTSTRAP SCRIPTS -->
<script src="/2/light-wave/light-wave/main-site/js/bootstrap.js"></script>
</body>
</html>
