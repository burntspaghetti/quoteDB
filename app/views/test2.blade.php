...
<head>
    ...
    <!-- css -->
    <link rel="stylesheet" href="Flusk-master/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="Flusk-master/assets/css/font-awesome.min.css">
    <link rel="stylesheet" href="Flusk-master/assets/css/style.css" media="screen"/>
...
<div id="wrapper">
    ...
    <div id="header" class="content-block">
        <section class="top clearfix">
            <div class="pull-left">
                <h1><a class="logo" href="index.html">Flusk</a></h1>
            </div>
        ...
        <section class="bottom">
            <a id="scrollToContent" href="#">
                <img src="Flusk-master/assets/images/arrow_down.png">
            </a>
        </section>
    </div><!-- header -->
    ...
    <div class="content-block" id="portfolio">
        <div class="container">
            ...
            <section class="block-body">
                <div class="row">
                    <div class="col-sm-4">
                        <a href="#" class="recent-work" style="background-image:url(Flusk-master/assets/images/rain_1-320x240.jpg)">
                            <span class="btn btn-o-white">Lorem Rocks</span>
                        </a>
                    </div>
                    <div class="col-sm-4">
                        <a href="#" class="recent-work" style="background-image:url(Flusk-master/assets/images/min_icons_thumb1-320x240.jpg)">
                            <span class="btn btn-o-white">Lorem Rocks</span>
                        </a>
                    </div>
                    <div class="col-sm-4">
                        <a href="#" class="recent-work" style="background-image:url(Flusk-master/assets/images/flat_icons_thumb.jpg)">
                            <span class="btn btn-o-white">Lorem Rocks</span>
                        </a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-4">
                        <a href="#" class="recent-work" style="background-image:url(Flusk-master/assets/images/wood-320x240.jpg)">
                            <span class="btn btn-o-white">Lorem Rocks</span>
                        </a>
                    </div>
                    <div class="col-sm-4">
                        <a href="#" class="recent-work" style="background-image:url(Flusk-master/assets/images/bike-320x240.jpg)">
                            <span class="btn btn-o-white">Lorem Rocks</span>
                        </a>
                    </div>
                    <div class="col-sm-4">
                        <a href="#" class="recent-work" style="background-image:url(Flusk-master/assets/images/six_1-320x240.jpg)">
                            <span class="btn btn-o-white">Lorem Rocks</span>
                        </a>
                    </div>
                </div>
            ...
            <section class="block-body">
                <div class="row">
                    <div class="col-sm-4 blog-post">
                        <img src="Flusk-master/assets/images/bike_water1-1000x600.jpg">
                    ...
                    <div class="col-sm-4 blog-post">
                        <img src="Flusk-master/assets/images/mac_glasses1-1000x600.jpg">
                    ...
                    <div class="col-sm-4 blog-post">
                        <img src="Flusk-master/assets/images/road-1000x600.jpg">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="testimonial">
                            <img src="Flusk-master/assets/images/testimonial_31-190x190.jpg">
                            <p>In at accumsan risus. Nam id volutpat ante. Etiam vel mi mattis, vulputate nunc nec, sodales nibh. Etiam nulla magna, gravida eget ultricies sit amet, hendrerit in lorem.</p>
                    ...
                    <div class="col-md-4">
                        <div class="testimonial">
                            <img src="Flusk-master/assets/images/testimonial_11-190x190.jpg">
                            <p>In at accumsan risus. Nam id volutpat ante. Etiam vel mi mattis, vulputate nunc nec, sodales nibh. Etiam nulla magna, gravida eget ultricies sit amet, hendrerit in lorem.</p>
                    ...
                    <div class="col-md-4">
                        <div class="testimonial">
                            <img src="Flusk-master/assets/images/testimonial_22-190x190.jpg">
                            <p>In at accumsan risus. Nam id volutpat ante. Etiam vel mi mattis, vulputate nunc nec, sodales nibh. Etiam nulla magna, gravida eget ultricies sit amet, hendrerit in lorem.</p>
...
<script src="Flusk-master/assets/js/jquery-2.1.3.min.js"></script>
<script src="Flusk-master/assets/js/jquery-migrate-1.2.1.min.js"></script>
<script src="Flusk-master/assets/js/bootstrap.min.js"></script>
<script src="Flusk-master/assets/js/jquery.actual.min.js"></script>
<script src="Flusk-master/assets/js/jquery.scrollTo.min.js"></script>
<script src="Flusk-master/assets/js/script.js"></script>
